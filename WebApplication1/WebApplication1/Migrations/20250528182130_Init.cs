    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "john.doe@gmail.com", "John", "Doe" });

            migrationBuilder.InsertData(
                table: "Medicament",
                columns: new[] { "IdMedicament", "Description", "Name", "Type" },
                values: new object[] { 1, "Opis", "NazwaNowa", "Kapsułki" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 5, 28, 20, 21, 30, 130, DateTimeKind.Local).AddTicks(2500), "Bogdan", "Boner" },
                    { 2, new DateTime(2025, 5, 28, 20, 21, 30, 146, DateTimeKind.Local).AddTicks(3610), "Domino", "Jachaś" }
                });

            migrationBuilder.InsertData(
                table: "Prescription",
                columns: new[] { "IdPrescription", "Date", "DoctorId", "DueDate", "PatientId" },
                values: new object[] { 1, new DateTime(2025, 5, 28, 0, 0, 0, 0, DateTimeKind.Local), 1, new DateTime(2025, 6, 4, 0, 0, 0, 0, DateTimeKind.Local), 1 });

            migrationBuilder.InsertData(
                table: "Prescription_Medicament",
                columns: new[] { "MedicamentId", "PrescriptionId", "Details", "Dose" },
                values: new object[] { 1, 1, "Szczegóły", 1 });
